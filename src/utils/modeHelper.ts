...
export default class BaseModel extends Object {
   ...
   */
  static initByList(list: any[], baseIndex = 0) {
    let array = [];
  ...
  formatMapFunc(key: string, oldValue: any) {
